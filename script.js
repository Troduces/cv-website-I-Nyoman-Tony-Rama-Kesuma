...
document.addEventListener("DOMContentLoaded", function () {
  ...
  */
  ...
  const textArray = [
    "Mahasiswa Teknik Elektro", // INSTRUKSI: Ganti dengan profesi Anda
    "IoT Enthusiast", // INSTRUKSI: Atau skill yang dikuasai
    "Electronic Project Maker", // INSTRUKSI: Bisa tambah sebanyak mungkin
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  form.addEventListener("submit", async function (e) {
    ...
    // Disable tombol dan tampilkan status loading
    ...
    try {
      ...
      status.textContent = "Gagal mengirim pesan. Periksa koneksi.";
    } finally {
      submitBtn.disabled = false;
    }
  });
